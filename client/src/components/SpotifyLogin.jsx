...
import aiDashboardProfile from "../assets/aiDashboardProfile.png";
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden"
      ...
      <div 
        ...
        style={{
          backgroundImage: `url(${aiDashboardProfile})`,
      ...
      <div className="flex flex-col items-center gap-8 px-6 text-center relative z-10">
        ...
        <div className="flex flex-col items-center gap-3">
          <img 
            src={aiProfile}
            alt="AI Profile - Sound Canvas"
            className="w-32 h-32 rounded-2xl object-cover shadow-lg border-2"
            style={{ borderColor: "rgba(29,185,84,0.5)" }}
          />
